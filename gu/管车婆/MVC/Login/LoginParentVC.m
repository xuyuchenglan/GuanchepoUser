...
{
    NSString *url_post = [NSString stringWithFormat:@"http://%@:80/zcar/userapp/loginByPhone.action", kIP];
...
{
    NSString *url_post = [NSString stringWithFormat:@"http://%@:80/zcar/userapp/getSmsAlidayu.action", kIP];
