...
@interface OrderContentInfoView()
{
...
@implementation OrderContentInfoView
...
- (void)addForthLine
{
    ...
    _dataLabel_xiadanWay = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(titleLabel.frame) + 20*kRate, 65*kRate, kScreenWidth - CGRectGetMaxX(titleLabel.frame) - 50*kRate, 20*kRate)];
