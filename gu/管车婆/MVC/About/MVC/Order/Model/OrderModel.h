...
@property (nonatomic, strong)NSArray        *items;//装载服务项目和服务数量的数组
...
@property (nonatomic, strong)NSString       *appointTime_start;//预约时间
@property (nonatomic, strong)NSString       *appointTime_end;//预约订单完成时间
